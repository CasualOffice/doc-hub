...
//!
//! Output format is up to `drive-bin/main.rs`'s `tracing_subscriber`
//! init — set `DRIVE_LOG_FORMAT=json` to get one JSON object per
...
//! middleware.
//!
//! Sampling is the operator's call: set `DRIVE_LOG_SAMPLE_RATE=0.1`
